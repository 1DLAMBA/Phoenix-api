    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p style="margin: 0 0 20px 0; color: #5a6c7d; font-size: 14px;">
                You have received a new message. Please see the details below:
            </p>
            
            <div class="info-section">
                <div class="info-row">
                    <div class="info-label">From</div>
                    <div class="info-value">{{ $sender->name }}</div>
                </div>
                
                <div class="info-row">
                    <div class="info-label">Email</div>
                    <div class="info-value">{{ $sender->email }}</div>
                </div>
                
                @if($sender->phoneno)
                <div class="info-row">
                    <div class="info-label">Phone</div>
                    <div class="info-value">{{ $sender->phoneno }}</div>
                </div>
                @endif
